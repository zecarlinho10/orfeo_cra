...
$sql="SELECT M.SGD_MRD_CODIGO, M.DEPE_CODI, D.DEPE_NOMB, M.SGD_SRD_CODIGO, S.SGD_SRD_DESCRIP, 
       M.SGD_SBRD_CODIGO, SS.SGD_SBRD_DESCRIP, T.RADI_NUME_RADI, R.RADI_PATH
FROM FLDOC.SGD_MRD_MATRIRD M,  FLDOC.DEPENDENCIA D, FLDOC.SGD_SRD_SERIESRD S, 
     FLDOC.SGD_SBRD_SUBSERIERD SS, FLDOC.SGD_RDF_RETDOCF T, FLDOC.RADICADO R
WHERE M.DEPE_CODI=D.DEPE_CODI AND M.SGD_SRD_CODIGO=S.SGD_SRD_CODIGO AND
      ...
      D.DEPE_CODI<900 AND T.SGD_MRD_CODIGO = M.SGD_MRD_CODIGO AND T.RADI_NUME_RADI=R.RADI_NUME_RADI
