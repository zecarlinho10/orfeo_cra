	...
	{	
		...
		if($permitir_busq > 0)
		{
		  if(!empty($rs) && $rs && !$rs->EOF)
		  {
            ...
            $msg = "<a href='$ruta_raiz/dlfl.php?ur=".base64_encode(openssl_encrypt($objReport->enlacePDF(),$ciphering,$salt))."' target='".date("dmYhhis")."' class='vinculos'>Abrir Archivo Pdf</a>";
