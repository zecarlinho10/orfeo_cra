        ...
        <table width="400px" cellpadding="0" cellspacing="0" onload="window.print()">
            <tr>
    	    	...
    	    	<table width="100%">
                    ...
                    <p><FONT SIZE=5>Destinatario  : <?=$destinatario?></FONT></p>
                    <p><FONT SIZE=5>Direccion     : <?=$direccion?> </FONT></p>
                    <p><FONT SIZE=5>Ciudad        : <?=$ciudad?> </FONT></p>
                    <p><FONT SIZE=5>Teléfono      : <?=$telefono?></FONT>
                </td>
            </tr>
        </table>
    </body>
