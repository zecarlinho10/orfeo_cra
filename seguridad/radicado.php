...
<tr><TD class=listado5 COLSPAN=2 ><center>Si selecciona Confidencial, El acceso al documento y a su informaci&oacute;n se restringe seg&uacute;n reglas del negocio.</TD></tr>
</center><tr>
...
if($grbNivel and $numRad)
{
	...
	if($db->conn->Execute($query))
	{
		...
		$Historico = new Historico($db);		  
  		$codiRegE[0] = $numRad;
		//echo "$codiRegE, $dependencia, $codusuario, $dependencia, $codusuario, $observa, 54"; 
