...
function getDiasParaRestar($codusuario,$dependencia,$trd,$tipo_usu){
    ...
    /********REGULACION**********/
    if($trd==1753 || $trd==1754 || $trd==1971 || $trd==1975){
        if($tipo_usu=="Asigna a proyectista"){
            $tiempoArestar = 26;
        }
        else if($tipo_usu=="Proyectista proyecta"){
            $tiempoArestar = 18;
        }
        else if($tipo_usu=="Revisor tematico: Revisa proyectado"){
            $tiempoArestar = 14;
        }
        else if($tipo_usu=="Revisor principal: Revisa proyectado"){
            $tiempoArestar = 10;
        }
        else if($tipo_usu=="Revisa respuesta final"){
            $tiempoArestar = 8;
        }
        else if($tipo_usu=="Firma y revisa"){
            $tiempoArestar = 0;
        }
        else if($tipo_usu=="Radicación de respuesta final"){
            $tiempoArestar = 8;
        }
    }
...
function getTipoUsuario($radicado,$db1){
    ...
    if($radicado!=""){
        ...
        switch ($mensaje) {
            ...
            case "Asigna a proyectista":
                $tipoUsuario="Asigna a proyectista";
                break;

            case "Proyectista proyecta":
                $tipoUsuario="Proyectista proyecta";
                break;
            case "Revisor tematico: Revisa proyectado":
                $tipoUsuario="Revisor tematico: Revisa proyectado";
                break;
            case "Revisor principal: Revisa proyectado":
                $tipoUsuario="Revisor principal: Revisa proyectado";
                break;
            case "Revisa respuesta final":
                $tipoUsuario="Revisa respuesta final";
                break;
            case "Firma y revisa":
                $tipoUsuario="Firma y revisa";
                break;
            case "Radicación de respuesta final":
                $tipoUsuario="Radicación de respuesta final";
                break;
