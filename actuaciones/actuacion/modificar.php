...
$pIdActuacion = $_POST['idNombreActuacion'];
...
<link href="../../estilos/jquery-ui.css" rel="stylesheet">
	...
	function confirmation() {
	    if(confirm("Confirma la modificación de la Actuación?"))
	    {
	        return true;
	    }
	    return false;
	...
	function notificacion(x){
	    ...
	    if(x==1){
	    	...
	    	alert("Error al Actualizar Actuación."); 	
	    }
...
<body id="public">
	<?php
		...
		if($pNombreActuacion){
			...
			$objActuacion->setId($pIdActuacion);
			...
			if($objCrudActuacion->actualizar($objActuacion)==true){
				?>
					<script> 
						notificacion(1);
					</script>
	...
	<div class="panel panel-primary">
		<div class="panel-heading">
			<h3>Formulario de Actualización Actuaciones Administrativas</h3>
		</div>
		<div class="panel-body">
			<div class="container-fluid">
				<form id="actuacion" class="" autocomplete="off"
					enctype="multipart/form-data" method="post" action="modificar.php" name="actuacion">
					<br />
									...
									<div class="row col-sm-12 col-md-12 dinamic">
										<div class="row form-group">
											<div class="col-sm-12  col-md-3">
												<label
													class="desc desc control-label etiqueta control-label label-success form-control" for="txtActuacion">Actuación
												</label>
											</div>
											<div class="col-sm-12  col-md-9">
												<select data-placeholder="Seleccione una opción"
													...
													id="txtActuacion" name="txtActuacion" onchange='cargarDatos();' required>
													<option value=''>-- SELECCIONE --</option>
														<?php foreach($objCrudActuaciones->getActuaciones(0) as $d):?>
										...
										<div class="row form-group">
											...
											<div class="col-sm-12  col-md-3 ">
												<input class="form-control" value=""
													...
													type="text" onblur='blurFunction()'/>

											</div>
											<div class="col-sm-12  col-md-3">
												<label
													class="desc  control-label etiqueta  control-label label-success  form-control"
													for="txtEstado">Estado*
												</label>
											</div>
											<div class="col-sm-12  col-md-3 ">
												<select data-placeholder="Seleccione una opción"
