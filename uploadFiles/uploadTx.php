...
$my_upload->upload_dir = BODEGA."/tmp/"; // "files" is the folder for the uploaded files (you have to create this folder)
...
if(isset($_POST['Realizar'])) {
	...
	$newFile = $valRadio;
	$uploadDir = BODEGA."/".substr($valRadio,0,4)."/".substr($valRadio,4,$digitosDependencia)."/";
	$fileGrb = substr($valRadio,0,4)."/".substr($valRadio,4,$digitosDependencia)."/$valRadio".".".substr($tmpFile,-3);
