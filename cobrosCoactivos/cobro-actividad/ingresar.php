...
<title>.:.Ingreso Obligaciones a Cobrar.:.</title>
<meta charset="utf-8">
...
<link href="../../estilos/jquery-ui.css" rel="stylesheet">
	...
	<script type="text/javascript"
		src="js/cobro-actividad.js?tes=<?php echo date("Ymdhis")?>">
	</script>
	...
	if($txtCobro){
		...
		$txtResolucion = $_POST['txtResolucion'];
		$txtValor = $_POST['txtValor'];
		$txtInteresAbonoCapital = $_POST['txtInteresAbonoCapital'];
		$txtAbonoInteres = $_POST['txtAbonoInteres'];
		$txtFechaPrescripcion = $_POST['txtFechaPrescripcion'];
		$txtVigencia = $_POST['txtVigencia'];
		$txtInteres = $_POST['txtInteres'];

		$objActividad = new CobroActividad();

		$objActividad->setIdCobro($txtCobro);
		$objActividad->setResolucion($txtResolucion);
		$objActividad->setValor($txtValor);
		$objActividad->setInteres($txtInteres);
		$objActividad->setInteresAbonoCapital($txtInteresAbonoCapital);
		$objActividad->setAbonoIntereses($txtAbonoInteres);
		$objActividad->setFechaPrescripcion($txtFechaPrescripcion);
		$objActividad->setVigencia($txtVigencia);
	...
	<div class="panel panel-primary">
		...
		<div >
			<div >
				...
				<script type="text/javascript">
					/*
					$.get("getFechaCobro.php","txtCobro="+<? echo $txtCobro ?>, function(data){
						$("#txtFechaPrescripcion").html(data);
						console.log(data);
					});
					*/
					$.get("getActividades.php","txtCobro="+<? echo $txtCobro ?>, function(data){
						$("#tabla").html(data);
						console.log(data);
					});
