...
<body id="public">
	<div class="container-fluid">
		<h1>&nbsp;</h1>
		<form id="contactoOrfeo" class="" autocomplete="off" enctype="multipart/form-data" method="post" action="formulario778-2tx.php" name="quejas">
			...
			<div class="row">
				...
				<div class="col-md-8 h3"
					...
					<span> <strong>Resolución CRA 778 de 2016</strong>
						<br /> 
						<span class="h5">MODELO DE CONDICIONES UNIFORMES DEL CONTRATO DE SERVICIOS PÚBLICOS PARA PERSONAS PRESTADORAS DE LA ACTIVIDAD DE APROVECHAMIENTO QUE ATIENDAN EN MUNICIPIOS DE MÁS DE 5.000 SUSCRIPTORES EN EL ÁREA URBANA, DE EXPANSIÓN URBANA.</span>
						<br /> 
			...
			<!-- ************************** pagina 2 **********************************-->
						<div class="pagina2"  style="display: none">
								...
								<div class="row">
									<div class="col-md-6" align="left">
										<label>La persona prestadora podrá anexar a este contrato un mapa en el cual se identifique el APS:</label>
									</div>
									<div class="row">
										<div id="li_upload">
								...
								<table border="1">
								   <div align="left">Cláusula 26. FRECUENCIAS Y HORARIOS PARA LA PRESTACIÓN DE LA ACTIVIDAD DE APROVECHAMIENTO EN EL APS DECLARADA. La persona prestadora de la actividad de aprovechamiento deberá diligenciar la siguiente tabla, especificando los horarios y frecuencias de recolección de los residuos aprovechables correspondientes a cada una de las macrorrutas definidas en el APS declarada.</div>

								   <caption>El prestador podrá incluir datos en el siguiente cuadro con letras y números.</caption>
								   <thead>
								       <tr>
								           <th>MACRORRUTA</th>
								           <th>DIAS DE RECOLECCIÓN DE RESIDUOS APROVECHABLES</th>
								           <th>HORARIO DE RECOLECCIÓN DE RESIDUOS APROVECHABLES</th>
								       </tr>
								   </thead>
