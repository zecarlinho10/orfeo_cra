...
<body id="public">
	<div class="container-fluid">
		<h1>&nbsp;</h1>
		<form id="contactoOrfeo" class="" autocomplete="off" enctype="multipart/form-data" method="post" action="formulario8942tx.php" name="quejas">
			...
			<!-- ************************** pagina 2 **********************************-->
						<div class="pagina2"  style="display: none">
								...
								<input type="button" id="next2_!" name="next2_1" value="Siguiente" onclick="validaPagina('873AAA2',2);"/>
							...
							<div class="pagina3"  style="display: none">
								...
								<div class="seltipo row form-group">
									<div class="col-sm-12  col-md-12 " align="left">
										<label></label><br>
										<label>CLÁUSULA 3. INMUEBLE. La PERSONA PRESTADORA, prestará el servicio en un inmueble:</label><br>
									</div>
								</div>
								<div class="seltipo row form-group">
								...
								<div class="seltipo row form-group">
									<div class="col-sm-9  col-md-9 " align="left">
										<label>CLÁUSULA 4.  VIGENCIA. El contrato se pacta a término</label><br>
									</div>
								</div>
								<div class="row">
									<div class="col-md-3" align="left">
								...
								<div class="seltipo row form-group">
									...
									<div class="col-sm-12  col-md-12 " align="left">
										...
										<table border="1">
										   <caption>Recolección y trasporte de residuos aprovechables:</caption>
										   ...
										   <tbody> <!-- Cuerpo de la tabla -->
										       <tr>
										           <td><input class="form-control" value="" name="C15_macro1_1" tabindex="1" id="C15_macro1_1" type="text" /></td>
										           <td><input class="form-control" value="" name="C15_macro1_2" tabindex="1" id="C15_macro1_2" type="text" /></td>
										           <td><input class="form-control" value="" name="C15_macro1_3" tabindex="1" id="C15_macro1_3" type="text" /></td>
										       </tr>
										   </tbody>
										</table>
									</div>
