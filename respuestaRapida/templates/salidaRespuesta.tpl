...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        ...
        <!--{/if}-->
        <center>
          <input name="Cerrar" type="button" class="btn btn-default btn-xs" id="envia22" onClick="window.parent.opener.$.fn.cargarPagina('./lista_anexos.php', 'tabs-c'); window.parent.close();" value="Cerrar">
        </center>
    </body>
</html>
