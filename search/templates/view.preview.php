...
<div class="row">
	<h1><a class="title" target="_blank" rel="noopener noreferrer" href="<?=$uri ?>"><?=$title ?></a></h1>
	</div>
...
<div class="content active" id="preview-image">
	<div class="panel">
	<a href="<?=$id?>" target="_blank" rel="noopener noreferrer"><img src="<?=$preview_image?>" /></a>
	</div>
...
<?php } // no preview image ?>
	...
	if ($preview_allowed) {
		...
		<a href="<?=$id?>" target="_blank" rel="noopener noreferrer"><img src="<?=$id?>" /></a>
		<?php
		} // if image
...
?>
	...
	<div class="commands">
		<a target="_blank" rel="noopener noreferrer" href="<?=$uri?>"><?php echo t('open'); ?></a> <?php if ($cfg['metadata']['server']) { ?> | <a target="_blank" rel="noopener noreferrer" title="<?php echo t('meta description'); ?>" href="<?php print get_metadata_uri ($cfg['metadata']['server'], $id); ?>"><?php echo t('meta'); ?></a> <?php } ?>
	</div>
