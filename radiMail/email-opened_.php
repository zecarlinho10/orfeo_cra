...
if($uid){
	...
	$hostname = '{'."$servidor_mail:$puerto_mail/ssl/novalidate-cert".'}';
	...
	if (empty($nurad) or !isset($nurad)){
		$buttonFiled='<button class="btn btn-primary btn-sm replythis"><i class="fa fa-reply"></i> Radicarecho '<script language="javascript">alert(".$nurad");</script>'; </button>';
