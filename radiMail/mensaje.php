...
<body>
	...
	<table width="100%" cellspacing="7" border="0" cellpadding="0"
		class="border">
		<tr>
			<td width=60%>&nbsp;</td>
			<td><span style="font-size: 84; font-family: 'Free 3 of 9'">*<?=$nurad?>*</span>
				<br>
	...
	<table class=border width=100%>
		...
		<tr>
			...
			<?
				$nueva = strtotime($date);
				$NuevaFecha = date ( 'd-m-Y H:i:s' , $nueva);
			?>
			<td class=listado><?=$NuevaFecha?></td>
		</tr>
		<tr>
		...
		<table class=border width=100%>
			<tr>
				<td class=titulo>Archivos Adjuntos <br>
					<?=$listaAdjuntos?>
				</td>
			</tr>
		</table>
