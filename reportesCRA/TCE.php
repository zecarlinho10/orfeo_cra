...
<form action="TCE.php?<?=$params?>" method="post" enctype="multipart/form-data" name="formSeleccion" id="formSeleccion" >
...
<table width="57%" border="0" cellspacing="5" cellpadding="0" align="center" class='table table-bordered table-striped mart-form'>
	<tr align="center">
		<td height="25" colspan="4" class='titulos2'>
			Reporte de Radicados Marcados con Traslado a Comité de Expertos
...
FROM
    ...
    MUNICIPIO M, DEPARTAMENTO DP, HIST_EVENTOS H
WHERE
