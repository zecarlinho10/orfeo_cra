...
<form action="ind_gest_new.php?<?=$params?>" method="post" enctype="multipart/form-data" name="formSeleccion" id="formSeleccion" >
...
$sql= "SELECT 'Todas las dependencias' as DEPE_NOMB, 0 AS DEPE_CODI FROM DEPENDENCIA
                 ...
                 WHERE DEPE_CODI IN (211,216,401,220,230,301)
...
<table border=2 align="center" class="table table-bordered table-striped mart-form" width="80%">
		...
		<td class="titulos2" align="center">RESPONSABLE</td>
                <td class="titulos2"  align="center">SEGUNDO ENVIO</td>
                <td class="titulos2"  align="center">PRIMER ENVIO</td>
                ...
                <td class="titulos2" align="center">SE NIEGA</td>
        </tr>
<?php
...
<?php
	...
	$ind= "$ind %";
		...
		if ($sel<>"TODOS")
		{
		echo "<p><span class=listado2>Radicados con cumplimiento: " . $i." " .$fvcmto1."</span>";	
