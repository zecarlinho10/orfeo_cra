...
<title>Reporte Indicador SEA/SER</title>
...
<form action="SER.php?<?=$params?>" method="post" enctype="multipart/form-data" name="formSeleccion" id="formSeleccion" >
