...
$titulos=array("DESTINATARIO","DIRECCION","CIUDAD_DEPTO","PESO","RADICADO");

			$isql = "SELECT SALIDA,SGD_RENV_NOMBRE,ID_PAIS, SGD_RENV_VALOR,SGD_RENV_PESO,
					SGD_RENV_DIR, SGD_RENV_FECH, SGD_RENV_MPIO||'-'||SGD_RENV_DEPTO AS CIUDAD_DEPTO FROM (SELECT REG.radi_nume_sal AS SALIDA,REG.SGD_RENV_NOMBRE,REG.SGD_RENV_DIR,R.ID_PAIS, REG.SGD_RENV_VALOR,REG.SGD_RENV_PESO,
...
error_reporting(0);
	...
	$campos_align = array("L","L","L","L","L","L");
	$campos_tabla = array("SGD_RENV_NOMBRE","SGD_RENV_DIR","CIUDAD_DEPTO","SGD_RENV_PESO","SALIDA");
	$campos_width = array (105,410,250,120,110,80);
