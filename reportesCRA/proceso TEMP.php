...
$isql = "select v1.RADICADO RADICADO1, v1.FECHA,TO_CHAR(v1.FECHA, 'dd/mm/yyyy,HH:MI:SS AM') FECHA1_FORMAT, v1.DESCRIPCION DESCRIPCION1, v1.CODIGO CODIGO1, v1.OPERACION OPERACION1,
v2.RADICADO RADICADO2, v2.FECHA,TO_CHAR(v2.FECHA, 'dd/mm/yyyy,HH:MI:SS AM') FECHA2_FORMAT, v2.DESCRIPCION DESCRIPCION2, v2.CODIGO CODIGO2, v2.OPERACION OPERACION2, '000' DEMORA
from
