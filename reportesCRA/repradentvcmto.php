...
sgd_dir_nomremdes REMITENTE, (M.MUNI_NOMB||' - '||DP.DPTO_NOMB) as UBICACION, R.FECH_VCMTO AS FVCMTO 
...
<table border=2 align="center" class="table table-bordered table-striped mart-form" width="80%">
        <tr>
                ...
                <td class="titulos2" align="center">DIAS HABILES</td>
				<!-- <td class="titulos2" align="center">DIAS HABILES FUNCIONARIO</td> -->
                <!-- <td class="titulos2" align="center">DIAS HABILES JEFE</td> -->
                <!-- <td class="titulos2" align="center">DIAS HABILES DIRECTOR</td> -->
                <td class="titulos2" align="center">DIAS CALENDARIO</td>
...
/*
if ($regfecha!=0){
	$fvcmto=date('Y-m-d', strtotime("$fvcmto"));
}
*/
...
//CARLOS RICAURTE 19/06/2018
//DIAS FUNCIONARIO-JEFE-DIRECTOR

$fechaHoy = date("Y-m-d");
$drh = $Dha->diasHabiles($fechaHoy,$fvcmto);
$drc = $Dha->getDiasRestantes($radicadoin,$fvcmto,$tipodoc);


/*
if($termino<=10 && $termino>=5){
	$diasFuncionario=$drh-5;
    $diasJefe=$drh-5;
    $diasDIrector=$drh-5;
}
elseif ($termino<5) {
    $diasFuncionario=$drh-2;
    $diasJefe=$drh-2;
    $diasDIrector=$drh-2;
}
else{
	$diasFuncionario=$drh-8;
    $diasJefe=$drh-6;
    $diasDIrector=$drh-4;
}
*/
...
<!-- 
                <td class="listado2" align="center"><?=$diasFuncionario?></td>
                <td class="listado2" align="center"><?=$diasJefe?></td>
                <td class="listado2" align="center"><?=$diasDIrector?></td>
 -->                
