  ...
  <table class="table table-bordered table-striped mart-form">
	...
	<tr>
  	...
  	<tr bordercolor="#FFFFFF">
		...
		<td align="center" class="listado2" width="48%">
			<p><a href='../reportesCRA/archivoHistorico/consultaESP.php?<?=$phpsession ?>&krd=<?=$krd?>' target='mainFrame' class="vinculos">8. Archivo Hist&oacute;rico</a>        </p>
		</td>
	...
	<tr>
  		...
  		<td align="center" class="listado2" width="48%">
  			<a href='../trd/informe_trd.php?<?=$phpsession ?>&krd=<?=$krd?>&krd=<?=$krd?>&<? echo "fechah=$fechah"; ?>' class="vinculos" target='mainFrame'>10. Listado  Tablas de Retencion Documental </a></td>
  		</td>   
	<tr bordercolor="#FFFFFF">
		<td align="center" class="listado2" width="48%">
	...
	<tr bordercolor="#FFFFFF"> 	
		<td align="center" class="listado2" width="48%">
			<a href='ccu.php?<?=$phpsession ?>&krd=<?=$krd?>' onClick="return true" onmouseover="window.status='';return true" onmouseout="window.status='';return true" target='mainFrame' class="vinculos">33.Reporte CCUS</a>
		</td> 	
		<td align="center" class="listado2" width="48%">
			<a href='busquedaradicado2.php?<?=$phpsession ?>&krd=<?=$krd?>' onClick="return true" onmouseover="window.status='';return true" onmouseout="window.status='';return true" target='mainFrame' class="vinculos">34.Reporte Busqueda Usuario Radicado</a>
		</td>
	</tr>
	<tr bordercolor="#FFFFFF"> 	
		<td align="center" class="listado2" width="48%">
			<a href='ind_gest_new.php?<?=$phpsession ?>&krd=<?=$krd?>' onClick="return true" onmouseover="window.status='';return true" onmouseout="window.status='';return true" target='mainFrame' class="vinculos">35.Reporte Indicador 3</a>
		</td>
		<td align="center" class="listado2" width="48%">
       		<a href='../atencion/reportes.php?<?=$phpsession ?>&krd=<?=$krd?>' onCli    ck="return true" onmouseover="window.status='';return true" onmouseout="wind    ow.status='';return true" target='mainFrame' class="vinculos">36.Atención al Ciudadano</a>
        </td>
    </tr>
  	<tr bordercolor="#FFFFFF"> 	
        <td align="center" class="listado2" width="48%">
       		<a href='ind_gest_new2.php?<?=$phpsession ?>&krd=<?=$krd?>' onCli    ck="return true" onmouseover="window.status='';return true" onmouseout="wind    ow.status='';return true" target='mainFrame' class="vinculos">37.Reporte PQRs</a>
        </td>
        <td align="center" class="listado2" width="48%">
       		<a href='./sinImagen.php?<?=$phpsession ?>&krd=<?=$krd?>' onCli    ck="return true" onmouseover="window.status='';return true" onmouseout="wind    ow.status='';return true" target='mainFrame' class="vinculos">38.Radicados sin imagen</a>
        </td>
    </tr>
    <tr bordercolor="#FFFFFF"> 	
        <td align="center" class="listado2" width="48%">
       		<a href='./asignados.php?<?=$phpsession ?>&krd=<?=$krd?>' onCli    ck="return true" onmouseover="window.status='';return true" onmouseout="wind    ow.status='';return true" target='mainFrame' class="vinculos">39.Radicados asignados</a>
        </td>
        <td align="center" class="listado2" width="48%">
       		<a href='./participacion/reporte40.php?<?=$phpsession ?>&krd=<?=$krd?>' onCli    ck="return true" onmouseover="window.status='';return true" onmouseout="wind    ow.status='';return true" target='mainFrame' class="vinculos">40. participacion</a>
        </td>
    </tr>		
</table>
</div>
