...
/*
	...
	//////////////////////////////////////////////////////
	// MODIFICADO POR PATCH - DOMINGO 13 DE 2008
	///////////////////////////////////////////////////////
	
	var errorString="<center>VSHOP -- CMS <br>Operaci&oacute; no Valida<br>Revise los datos del formulario<br>De ser necesario consulte a Soporte T&eacute;cnico </center>";
	//errorString+="\nReceived:\n"+r.responseText;
	...
	ModalAlerta("Operaci�n no v�lida",errorString,'400px');document.body.style.cursor='default';
	...
	errorString+="\nReceived:\n"+r.responseText;trimmedResponseText=r.responseText.replace(/^\s+/g,"");
	trimmedResponseText=trimmedResponseText.replace(/\s+$/g,"");
	if(trimmedResponseText!=r.responseText)
	errorString+="\nYou have whitespace in your response.";
	alert(errorString);document.body.style.cursor='default';
	if(xajaxStatusMessages==true){window.status='Invalid XML response error';}}
