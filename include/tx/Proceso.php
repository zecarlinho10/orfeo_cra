...
function __construct( $db, $nombreProceso,$serieProceso = null, $subSerieProceso = null, 
...
var $estiloExito = "class=titulos>";
	...
	function insertaEtapa(){
		...
		$queryYaExiste = "select sgd_fexp_codigo as EXISTE FROM sgd_fexp_flujoexpedientes where sgd_fexp_descrip = '" . $this->etapa->getDescripcion() . "' and SGD_PEXP_CODIGO = '" . $this->etapa->getCodigoProceso() . "'";	//GTS
