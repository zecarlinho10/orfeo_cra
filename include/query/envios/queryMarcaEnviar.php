 ...
 case 'oci8po':
	...
	$isql = "SELECT 
	        b.RADI_NUME_RADI as RADI_NUME_RADI,a.ANEX_NOMB_ARCHIVO,a.ANEX_DESC,a.SGD_REM_DESTINO,a.SGD_DIR_TIPO
  		   ,a.ANEX_RADI_NUME as ANEX_RADI_NUME, a.RADI_NUME_SALIDA as RADI_NUME_SALIDA, TDOC_CODI, E.SGD_EXP_NUMERO
		 FROM ANEXOS a, 
    		RADICADO b LEFT JOIN SGD_EXP_EXPEDIENTE E ON B.RADI_NUME_RADI = E.RADI_NUME_RADI
		 WHERE a.radi_nume_salida=b.radi_nume_radi
