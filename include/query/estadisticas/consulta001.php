...
switch($db->driver)
{
	...
	{	if($tipoDocumento=='9999')
		...
		$queryEDetalle = "SELECT DISTINCT $radi_nume_radi as RADICADO
			...
			,r.RADI_USU_ANTE
			,ra.usua_nomb AS USUA_NOMB_ACTUAL
...
if($genDetalle==1){
	$titulos=array("#","1#RADICADO","2#FECHA RADICADO","3#TIPO DOCUMENTO","4#ASUNTO","5#USUARIO","6#REMITENTE","7#DEPENDENCIA_INICIAL","8#DEPENDENCIA_ACTUAL","9#USUARIO ACTUAL","10#NUM FOLIOS");
}
else 		
