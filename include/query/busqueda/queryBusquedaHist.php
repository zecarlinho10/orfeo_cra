<?
 ...
 case 'oci8po':
	...
	break;
	default:
		  $isqlT = 'SELECT cast(r.radi_nume_radi as varchar(20)) as "IMG_Radicado" 
                                ,r.RADI_PATH as "HID_RADI_PATH"
                                ,'.$sqlFecha.' as "DAT_Fecha_Radicado"
                                , cast(r.RADI_NUME_RADI as varchar(20)) as "HID_Numero Radicado",
                                R.RADI_NOMB as "Nombre",
	                        R.RADI_PRIM_APEL as "Apellido 1",
                                R.RADI_SEGU_APEL as "Apellido 2",
       		                R.RADI_NUME_IDEN as "Identificacion", 
            ...
            $isqlT1 = 'select '.$depe.' as "HID_R_RADI_DEPE_ACTU" 
                               		, cast(r.radi_nume_radi as varchar(20) as "IMG_Radicado" 
                                        , r.RADI_PATH as "HID_RADI_PATH"
                                        ,'.$sqlFecha.' as "DAT_Fecha_Radicado"
                                        , cast(r.radi_nume_radi as varchar(20)) as "HID_Numero Radicado"
                                        , cast(H.RADI_NUME_RADI as varchar(20)) as "HID_H_RADI_NUME_RADI", 
                                        R.RADI_NOMB as "Nombre",
