...
switch ($db->driver) { 
 ...
 case 'oci8po':
	...
	break;
	case 'postgres':
		$query1="select a.sgd_dir_codigo,a.sgd_dir_direccion,a.sgd_dir_telefono,a.sgd_dir_mail,b.sgd_ciu_nombre AS NOMBRE,b.SGD_CIU_APELL1 AS APELL1,b.SGD_CIU_APELL2 AS APELL2,b.SGD_CIU_CEDULA,a.SGD_DIR_TIPO,b.sgd_ciu_codigo, b.MUNI_CODI, b.DPTO_CODI, b. ID_PAIS, b.ID_CONT
	         from sgd_dir_drecciones a
	         LEFT OUTER JOIN  sgd_ciu_ciudadano b ON   a.sgd_ciu_codigo = b.sgd_ciu_codigo
	         where
