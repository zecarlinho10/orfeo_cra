...
$frad=date("Y-m-d h:i:s A");
 ...
 case 'oci8po':
	...
	SGD_ARCHIVO_FECHPRESTF,depe_codi,sgd_archivo_usua,sgd_archivo_fech,sgd_archivo_proc,sgd_archivo_fechaa,sgd_archivo_ncarp,SGD_ARCHIVO_DOCU2,sgd_archivo_dir
	,sgd_archivo_caja2) values ($sec,'$rad','$orden','$fechaIni','$fechaInif','$ano','$depe','$demq','$demtq','$docu',$codiSRD,
	$codiSBRD,'$proc','$folios','$zon','$carro','$cara','$estante','$entre','$caja','$unidocu','$inder','$mata','$anexo','$presta','$funprest','$fprest','$fechaPrestf','$depeU','$krd',$dat,'$tip','$fechaa','$numCap','$docu2','$dir','$caja2')";//TO_DATE('$frad','YYYY-MM-DD HH:MI:SS AM'))";
	...
	SGD_ARCHIVO_FECHPRESTF='$fechaPrestf',sgd_archivo_rad='$rad1',sgd_archivo_proc='$tip',sgd_archivo_fechaa='$fechaa',sgd_archivo_ncarp='$numCap',sgd_archivo_docu2='$docu2',sgd_archivo_dir='$dir',sgd_archivo_caja2='$caja2' ";
	$sqlm.=$qte;
	...
	sgd_archivo_depe,sgd_archivo_demandado,sgd_archivo_demandante,sgd_archivo_cc_demandante,sgd_archivo_srd,sgd_archivo_sbrd,sgd_archivo_tipo,
	sgd_archivo_folios,sgd_archivo_zona,sgd_archivo_carro,sgd_archivo_cara,sgd_archivo_estante,sgd_archivo_entrepano,sgd_archivo_caja,
	sgd_archivo_unidocu,sgd_archivo_inder,sgd_archivo_mata,sgd_archivo_anexo,depe_codi,sgd_archivo_usua,sgd_archivo_fech,sgd_archivo_prestamo,sgd_archivo_proc,sgd_archivo_fechaa,sgd_archivo_ncarp,SGD_ARCHIVO_DOCU2,sgd_archivo_dir,sgd_archivo_caja2";
	...
	$codiSBRD,'$proc','$folios','$zon','$carro','$cara','$estante','$entre','$caja','$unidocu','$inder','$mata','$anexo','$depeU','$krd',TO_TIMESTAMP('$frad','YYYY-MM-DD HH:MI:SS AM'),'$presta','$tip','$fechaa','$numCap','$docu2','$dir','$caja2'";
	...
	,sgd_archivo_sbrd=$codiSBRD,sgd_archivo_tipo='$proc',sgd_archivo_folios='$folios',sgd_archivo_zona='$zon',sgd_archivo_carro='$carro',sgd_archivo_cara='$cara',
	sgd_archivo_estante='$estante',sgd_archivo_entrepano='$entre',sgd_archivo_caja='$caja',sgd_archivo_unidocu='$unidocu',sgd_archivo_inder='$inder',
	sgd_archivo_mata='$mata',sgd_archivo_anexo='$anexo',sgd_archivo_rad='$rad1',sgd_archivo_proc='$tip',sgd_archivo_fechaa='$fechaa',sgd_archivo_ncarp='$numCap',sgd_archivo_docu2='$docu2',sgd_archivo_dir='$dir',sgd_archivo_caja2='$caja2'";
