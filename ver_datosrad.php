...
$datos_envio ="&otro_us11=".urlencode($otro_us1)."&dpto_nombre_us11=".urlencode($dpto_nombre_us1)."&muni_nombre_us11=".urlencode($muni_nombre_us1)."&direccion_us11=".urlencode($direccion_us1)."&nombret_us11=".urlencode($nombret_us1);
$datos_envio.="&otro_us2=".urlencode($otro_us2)."&dpto_nombre_us2=".urlencode($dpto_nombre_us2)."&muni_nombre_us2=".urlencode($muni_nombre_us2)."&direccion_us2=".urlencode($direccion_us2)."&nombret_us2=".urlencode($nombret_us2);
$datos_envio.="&dpto_nombre_us3=".urlencode($dpto_nombre_us3)."&muni_nombre_us3=".urlencode($muni_nombre_us3)."&direccion_us3=".urlencode($direccion_us3)."&nombret_us3=".urlencode($nombret_us3);
...
$isql = "select
			...
			fech_vcmto,
			sgd_tpr_termino,
         	to_date(fech_vcmto)-to_date(SYSDATE) diasparavencimiento,
		    (fech_vcmto) - to_date(radi_fech_radi)  diasplazo,
			to_date(SYSDATE)-to_date(radi_fech_radi)  diashoy
