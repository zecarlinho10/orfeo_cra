...
<form name="inf_trd"  action='../Etrd/informe_trd2.php?<?=session_name()."=".session_id()."&krd=$krd&fecha_h=$fechah"?>' method=post>
	...
	while(!$rs->EOF and $rs)
	{
			...
			}else
			{
				...
				if($soporte=="O") $soporteO = "X";
				 ...
				 $nObservacion = $rs->fields['SGD_SBRD_ARMAEXPEDIENTE'];
