    ...
    <td><table width="100%"  border="0" cellpadding="0" cellspacing="0" class="borde_tab">
      <tr>
		...
		$isql = "select a.SGD_FLD_CODIGO,
		 ...
		 ,a.SGD_FLD_IMAGEN
		 ,a.SGD_FLD_GRUPOWEB
		 FROM SGD_TPR_TPDCUMENTO B RIGHT JOIN SGD_FLD_FLUJODOC a ON
			a.sgd_tpr_codigo=b.SGD_TPR_CODIGO
		 where
		  b.sgd_tpr_codigo='$tdoc'
...
<table width="99%" class="borde_tab" align="center">
  <tr>
    <td height="25" class="titulos2">DOCUMENTOS ANEXOS</td>
  </tr>
</table>
<CENTER>
...
<table><tr><td><br></td></tr></table>
 <table width="99%" class="borde_tab">
  <tr>
    <td height="25" class="titulos2">DATOS DE ENVIOS REALIZADOS</td>
  </tr>
</table>
<table  width="99%" class="borde_tab" align="center"  >
