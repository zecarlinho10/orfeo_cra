...
switch($tipoEstadistica){
	...
	break;
	case "21";
	include "$ruta_raiz/include/query/estadisticas/consulta021.php";
	$generar = "ok";
	break;
	case "22";
...
function Exportar($ruta_raiz,$queryE,$titulo){ ?>
	...
	echo "<b><a href='$ruta_raiz/reportes/adodb-doc.inc.php' target='_blank'><img src='$ruta_raiz/images/compfile.png' width='40' heigth='40' border='0'></a></b> - "; //
	echo "<a href='$ruta_raiz/reportes/adodb-xls.inc.php' target='_blank'><img src='$ruta_raiz/images/spreadsheet.png' width='40' heigth='40' border='0'></a>";
	?>
		</td>
		</tr>
		</table><?php
