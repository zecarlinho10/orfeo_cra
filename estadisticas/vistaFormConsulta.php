...
//$tituloE[18] = "ESTADISTICA POR RADICADOS CON SERIE";
...
$helpE[19] = "Este reporte genera la cantidad de documentos para PQR. " ;
$helpE[20] = "Este reporte genera los radicados con  cuatro (4) vistos buenos filtrados por tipo de radicado" ;
$helpE[21] = "Muestra la cantidad de raricados en bandeja de usuarios jefes" ;
$helpE[22] = "Muestra la cantidad de raricados en bandeja totales o por dependencias" ;
?>
...
if($tipoEstadistica==1 or $tipoEstadistica==2 or $tipoEstadistica==3 or
		...
		$tipoEstadistica==12 or $tipoEstadistica==17  or $tipoEstadistica==18 or $tipoEstadistica==20 )
{
	?>
		<tr>
...
if($tipoEstadistica==1 or $tipoEstadistica==2 or $tipoEstadistica==3 or
		...
		$tipoEstadistica==17  or $tipoEstadistica==19  or $tipoEstadistica==20  or $tipoEstadistica==21  or $tipoEstadistica==22  ) { ?>
	<tr>
