...
<?if ($_SESSION['entidad']=="CRA"){?>
                          <td class='listado2' >
                          <a href='../envios/cuerpoEnvioE-mail.php?<?=$datos_enviar?>&estado_sal=3&estado_sal_max=3&krd=<?=$krd?>&nomcarpeta=Radicados Para Envio' class='vinculos'>Envio E-mail
                          </a>
                          </td>
<?}?>
                          ...
                          <td class='listado2' ><a href='../radsalida/cuerpo_masiva.php?<?=$datos_enviar?>&krd=<?=$krd?>&estado_sal=3&estado_sal_max=3' class='vinculos'>Masiva
                           ...
                           <!--AGREGADO ENERO 2016 NEMESIS-->
						  </a></td>
						  <td class='listado2' ><a href='../envios/reenviomass.php?<?=$datos_enviar?>&krd=<?=$krd?>&estado_sal=3&estado_sal_max=3' class='vinculos'>Reenv Rad Masiva
			              </a></td>
						  
						  <td class='listado2'><b><a href='../reportesCRA/envios_planilla.php?<?=$datos_enviar?>&krd=<?=$krd?>' class='vinculos'>Generacion de Planillas
                          y Guias 
                          </a></td>
