...
if ($nextval==-1)
{
	echo "<span class='etextomenu'>No se encontr&oacute; la secuencia sec_dir_drecciones ";
}
...
if($documento_us1 and $cc)
{
	...
	if($newId==true)
		...
		{
			//$db->conn->RollbackTrans();
			echo "<span class='etextomenu'>No se encontrase&nacute;a la secuencia sec_dir_drecciones ";
		}
