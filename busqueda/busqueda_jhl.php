...
*/
  ...
  $ps_solo_nomb = get_param("s_solo_nomb");
   ...
   $array_nombre = explode(" ",strip(get_param("s_RADI_NOMB"))."    ");
   $where_split = "";
   if(strip(get_param("s_RADI_NOMB")))
   {
	   if($array_nombre[0]) {$where_split = " and CONCAT(CONCAT(d.sgd_ciu_nombre,d.sgd_ciu_apell1),d.sgd_ciu_apell2) LIKE '%". $array_nombre[0] ."%' ";}
	   if($array_nombre[1]) {$where_split .= " and  CONCAT(CONCAT(d.sgd_ciu_nombre,d.sgd_ciu_apell1),d.sgd_ciu_apell2) LIKE '%". $array_nombre[1] ."%' ";}
	   if($array_nombre[2]) {$where_split .= " and CONCAT(CONCAT(d.sgd_ciu_nombre,d.sgd_ciu_apell1),d.sgd_ciu_apell2) LIKE '%". $array_nombre[2] ."%' ";}
	   if($array_nombre[3]) {$where_split .= " and CONCAT(CONCAT(d.sgd_ciu_nombre,d.sgd_ciu_apell1),d.sgd_ciu_apell2) LIKE '%". $array_nombre[3] ."%' ";}         
   }
  if($HasParam)
