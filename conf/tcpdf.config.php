...
$tcpdf ['base_directory'] = realpath ( dirname ( __FILE__ ) ."/../") . '/include/tcpdf/';
...
$tcpdf ['enable_disk_cache'] = TRUE;
$tcpdf ['cache_directory'] = sys_get_temp_dir().'/';

if($tcpdf ['enable_disk_cache']){
	@define('K_PATH_CACHE',$tcpdf ['cache_directory']);
}
 ...
 * ----------------------------------------------------------
 * This is the image directory for TCPDF.
 * This is where you
...
$tcpdf ['image_directory'] =  realpath ( dirname ( __FILE__ ) ."/../img/");//$tcpdf ['base_directory'] . 'images/';
...
$tcpdf ['language_file'] = $tcpdf ['base_directory'] . '/lang/spa.php';
...
$tcpdf ['creator'] = 'orfeocra';
$tcpdf ['author'] = 'orfeocra';
...
$tcpdf ['header_margin'] = 4;
$tcpdf ['header_title'] = 'Orfeo';
$tcpdf ['header_string'] = "Sistema de Gestión Documental Orfeo";
$tcpdf ['header_logo'] = 'logo_cra.jpg';
$tcpdf ['header_logo_width'] = 60;
