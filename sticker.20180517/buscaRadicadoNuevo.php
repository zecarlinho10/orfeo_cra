...
<table width="57%" border="0" cellspacing="5" cellpadding="0" align="center" class='table table-bordered table-striped mart-form'>
		...
		<tr align="center">
		  ...
		  <tr align="center">
				...
				<td width="69%" height="30" class='listado2' align="left">
					<input name="destinatario" id="destinatario" value="<?=$nombre?>" type="input" size="50" class="tex_area">
				</td>
		  </tr>
		  <tr align="center">
		  ...
		  <tr align="center">
				...
				<td width="69%" height="30" class='listado2' align="left">
					<input name="empresa" id="empresa" value="<?=$nomempresa?>" type="input" size="50" class="tex_area">
				</td>
		  </tr>
		  <tr align="center">
