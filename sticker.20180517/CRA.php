...
$isql="
        SELECT S.DEPE_CODI, D.DEPE_NOMB, S.SGD_SRD_CODIGO, SE.SGD_SRD_DESCRIP, S.SGD_SBRD_CODIGO, SS.SGD_SBRD_DESCRIP, SGD_SEXP_PAREXP1, S.SGD_EXP_NUMERO
    ...
    <table width="400px" cellpadding="0" cellspacing="0" onload="window.print()">
        <tr>
            <td  align=left width="300px">
                ...
                <h1>EXP: <?=$numexp?></h1>
                <p><span>Carpeta No:___ De:___</span></p>
            </td>
        </tr>
    </table>
</body>
