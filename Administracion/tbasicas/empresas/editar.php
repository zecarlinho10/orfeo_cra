...
<td width="20%" align="center" class="titulos2">NIT ENTE</td>
<td width="20%" align="center"><input class="tex_area" type="text" name="txt_esp_nit" id="txt_esp_nit" size="60" maxlength="200" value='<?=$txt_esp_nit?>'></td>
...
if(!empty($_POST['Buscar'])&& ($_POST['Buscar']=="Buscar"))	
{
	...
	from bodega_empresas where nombre_de_la_empresa like '%".strtoupper($_POST['txt_esp'])."%' AND nit_de_la_empresa like '%".$_POST['txt_esp_nit']."%' and activa=1";
	//$db->conn->debug = true;
...
{
	$supdate= ("update bodega_empresas set nit_de_la_empresa ='".ltrim($_POST['txt_nit'])."', nombre_de_la_empresa ='".strtoupper($_POST['txt_esp1'])."',nombre_rep_legal='".strtoupper($_POST['txt_rep'])."',cargo_rep_legal='".strtoupper($_POST['txt_cargo'])."',direccion='".strtoupper($_POST['txt_dir'])."',telefono_1='".$_POST['txt_tel1']."',telefono_2='".$_POST['txt_tel2']."',email='".strtolower($_POST['txt_email'])."',id_cont=".$cont.",id_pais=".$pais_e.",codigo_del_departamento=".$dpto.",codigo_del_municipio=".$muni." where identificador_empresa=".$_POST['txt_iden']);
        //$db->conn->debug = true;
