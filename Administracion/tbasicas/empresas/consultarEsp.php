...
<td width="20%" align="center" class="titulos2">NIT EMPRESA E.S.P.</td>
...
$sqlesp="select b.nit_de_la_empresa,
	     ...
	     and b.nombre_de_la_empresa like '%".strtoupper($_POST['txt_esp'])."%' AND b.nit_de_la_empresa like '%".$_POST['txt_esp_nit']."%'";
	//$db->conn->debug = true;
	$rs=$db->query($sqlesp);
	if($rs && !$rs->EOF)
	{
