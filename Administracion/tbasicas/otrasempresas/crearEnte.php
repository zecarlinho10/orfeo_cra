...
$txt_ente=$_POST['txt_ente']; 
$txt_tipo=$_POST['txt_tipo']; 
$txt_repre=$_POST['txt_repre']; 
...
<tr>
<td colspan="2" width="30%" align="center" valign="middle" class="titulos2">REPRESENTANTE</td>
<td width="30%" align="center" valign="middle" class="titulos2">NIT</td>
</tr>
<tr align="center">
<td colspan="2" width="33%"><input size="60" class="tex_area" type="text" name="txt_repre" id="txt_repre" maxlength="50" value='<?=$txt_repre?>'></td>
...
<tr>
<td colspan="3" align="center" valign="middle"><input class="tex_area" type="text" name="txt_dir" id="txt_dir" size="60" maxlength="160" value='<?=$txt_dir?>'></td>
</tr>
<tr>
...
if(!empty($_POST['Incluir'])&& ($_POST['Incluir']=="Incluir"))
{
 ...
 //$db->conn->debug = true;
	...
	if ($carnit=="" || $caresp==""){
		...
		$conse=$conse+1;
		$sinsert=("INSERT INTO SGD_OEM_OEMPRESAS(SGD_OEM_CODIGO,TDID_CODI,SGD_OEM_OEMPRESA,SGD_OEM_REP_LEGAL,SGD_OEM_NIT,SGD_OEM_SIGLA,MUNI_CODI,DPTO_CODI,SGD_OEM_DIRECCION,SGD_OEM_TELEFONO,ID_PAIS,ID_CONT,SGD_OEM_ESTADO,EMAIL) VALUES (".$conse.",4, '".strtoupper($_POST['txt_ente'])."', '".strtoupper($_POST['txt_repre'])."','".ltrim($_POST['txt_nit'])."', '".strtoupper($_POST['txt_sigla'])."', ".$muni.",".$dpto.",'".strtoupper($_POST['txt_dir'])."', '".$_POST['txt_tel2']."', ".$pais1.", ".$cont.", 1,'".strtolower($_POST['txt_mail'])."')");
