...
{
	window.open('listados.php?<?=session_name()."=".session_id()?>&var=bge','','scrollbars=yes,menubar=no,height=600,width=800,resizable=yes,toolbar=no,location=no,status=no');
}
