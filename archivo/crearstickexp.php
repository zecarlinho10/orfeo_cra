...
foreach ($_POST as $elementos => $valor) {
	...
	/**  Procedimiento que Crea el Numero de  Expediente
	  ...
	  */
	  	...
	  	$numeroExpedienteE = $expediente->crearExpediente( $numeroExpediente,$nurad,$codepe,$codusuario,$usua_doc,$usuaDocExp,$codiSRD,$codiSBRD, 'false',$fechaExp, $codProc, $arrParametro, $tipo );
		...
		}else
		{
			...
			$Historico->insertarHistoricoExp($numeroExpediente,$radicados, $dependencia,$_SESSION["codusuario"], $observa, $tipoTx,0);
			include ("$ruta_raiz/include/tx/Flujo.php");
			$codProc = (empty($_POST['codProc']))?'0':$_POST['codProc'];
...
<tr align="left" colspan="2">
		<td width="31%" class='titulos5'>DEPENDENCIAz</td>
