...
<body  topmargin="0" bgcolor="#ffffff">
  ...
  <table BORDER=0  cellpad=2 cellspacing='0' WIDTH=98% class='t_bordeGris' valign='top' align='center' >
   ...
   <form method="POST" action="sacar_grupo_registro.php?grupo=<?=$grupo."&pagina=".$pagina."&krd=".$krd."&fechah=".$fechah."&dep_sel=".$dep_sel."&estado_sal=".$estado_sal."&estado_sal_max=".$estado_sal_max?>" name="formSacarGrupo">
          <input type='hidden' name='<?=session_name()?>' value='<?=session_id()?>'> 
