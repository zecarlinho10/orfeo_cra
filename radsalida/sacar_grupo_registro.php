...
<form name="form1" method="post" action="lista_sacar_grupo.php?grupo=<?=$grupo?>&pagina=<?=$pagina?><delete from sgd_rmr_radmasivre where sgd_rmr_radi=20061500086361 and sgd_rmr_grupo=20061500086361?=session_name()."=".session_id()."&krd=$krd&fechah=$fechah&dep_sel=$dep_sel&estado_sal=$estado_sal&estado_sal_max=$estado_sal_max" ?>
