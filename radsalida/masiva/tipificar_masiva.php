...
print $rsD->GetMenu2("codserie", $codserie, "0:-- Seleccione --", false,"","onChange='submit()' class='select select100'" );
?>
		</td>
 	<tr align="center">
...
include("$ruta_raiz/include/query/trd/queryCodiDetalle.php"); $querySub = "select distinct ($sqlConcat) as detalle, su.sgd_sbrd_codigo
...
include "$ruta_raiz/include/tx/ComentarioTx.php";
		print $rsSub->GetMenu2("tsub", $tsub, "0:-- Seleccione --", false,"","onChange='submit()' class='select select100'" );
?>
		</td>
	</tr>
  	<tr align="center">
...
include "$ruta_raiz/include/tx/ComentarioTx.php";
print $rsTip->GetMenu2("tipo", $tipo, "0:-- Seleccione --", false,"","onChange='submit()' class='select select100'" );
?>
</tr>
</table>
...
<table width="70%" align="center" border="0" cellpadding="0" cellspacing="5" class="borde_tab">
	...
	<tr align="center">
		...
		<td width="84%" height="30" class="listado2">
			<?php
				$cad = "USUA_PRAD_TP";
				// Creacion del combo de Tipos de radicado habilitados segun permisos
				...
				reset($Vec_Perm);
			?>
			<select name="tipoRad" id="Slc_Trd" class="select select100" onchange="submit();">
				<?
