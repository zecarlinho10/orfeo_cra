...
if ($radiNumero == '') {
    ...
    echo "<a class=vinculos href='$arpdf_tmp' target='" . date("dmYh") . date("his") . "'>Abrir Archivo Pdf</a>";
    echo "<br>";
    $salida = "csv";
    echo "Para obtener el archivo csv guarde del destino del siguiente v&iacute;nculo  <a class=vinculos href='$archivo' target='" . date("dmYh") . date("his") . "'>Generado
              </a>";
}
