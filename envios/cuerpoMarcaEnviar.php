...
function continuar(){
	accion = '<?=$ruta_raiz.$pagina_sig?>."?"krd=$krd&fechah=$fechah&dep_sel=$dep_sel&estado_sal=$estado_sal&usua_perm_impresion=$usua_perm_impresion&estado_sal_max=$estado_sal_max" ?>';
	alert (accion);
}
...
<?
 ...
 if($estado_sal==2){
	...
	$pagina_sig = "/envios/cuerpoMarcaEnviar.php";
...
<?php
  ...
  $encabezado = "dep_sel=$dep_sel&krd=$krd&estado_sal=$estado_sal&usua_perm_impresion=$usua_perm_impresion&fechah=$fechah&estado_sal_max=$estado_sal_max&ascdesc=$ascdesc&orno=";
  $fechah=date("dmy") . "_". date("h_m_s");
 	$check=1;
              ...
              <div class="widget-body no-padding">
                 <table class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    <a href='<?= $ruta_raiz.$pagina_actual?>?<?=$encabezado?>98&ordcambio=1' alt='Ordenar Por Leidos' >
                    <span class='leidos'>Impresos</span></a>
                    <?=$img7 ?> <a href='<?=$ruta_raiz.$pagina_actual?>?<?=$encabezado?>99&ordcambio=1'  alt='Ordenar Por Leidos'><span class='no_leidos'>
                    Por Imprimir</span></a>

                    </td>
                    <td class="titulos2" align="center">
                    <a href='<?=$ruta_raiz.$pagina_sig?>?<?=$encabezado?> '></a>
...
?>
 ...
 <form name='formEnviar'  method=post onsubmit="myFunction()" action=<?= $ruta_raiz.$pagina_sig ?>?<?= "krd=$krd&fechah=$fechah&dep_sel=$dep_sel&estado_sal=$estado_sal&usua_perm_impresion=$usua_perm_impresion&estado_sal_max=$estado_sal_max" ?> 
              ...
              <table class="table table-bordered table-striped">
                <tr class='titulos3' >
                  ...
                  <td width='8%' align="center">
                  	<a href='<?="?".$encabezado ?>1&ordcambio=1&orno=1' class='textoOpcion' alt='Ordenamiento'>
                  		<?=$img1 ?>
                  		Radicado Salida
                  	</a>
                  </td>
                  <td  width='5%' align="center">
                  	<a href='<?="?".$encabezado ?>1&ordcambio=1&orno=2' class='textoOpcion' alt='Ordenamiento'>
                  		<?=$img2 ?>
                  		Copia
                  	</a>
                  </td>
                  <td  width='9%' align="center">
                   	  <a href='<?="?".$encabezado ?>1&ordcambio=1&orno=3' class='textoOpcion' alt='Ordenamiento'>
                      	<?=$img3 ?>
                      	Radicado Padre
                      </a>
                  </td>
                  <td  width='9%' align="center">
                  	<a href='<?="?".$encabezado ?>1&ordcambio=1&orno=4' class='textoOpcion' alt='Ordenamiento'>
                  		<?=$img4 ?>
                  		Fecha Radicado
                  	</a>
                  </td>
  ...
  <tr>
    <td width='50%' align='left' height="30" class="titulos2" ></td>
       <td width='50%' align="center" class="titulos2" >
        <a href='<?=$ruta_raiz.$pagina_actual?>?<?=$encabezado?> '></a>
       <input type=submit value="Generar listado para Estos radicados" name=Enviar id=Enviar valign='middle' class='botones_largo'>
     </td>
   </tr>
</table>
