...
//echo ">>>".$myvar = grab_dump($_POST['checkValue']);
...
//var_dump($checkValue); 
  ...
  $count = count($checkValue);
   for ($i = 0; $i < $count; $i++) {
  $radicados123 .= $checkValue[$i].",";
      
   }
   $radicados124 = trim($radicados123, ",");
   $_SESSION['radicadosparaimprimir'] = "(".$radicados124.")";
   }
 ?>
