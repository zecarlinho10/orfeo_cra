...
// incluye la clase Db
	...
	class CrudPrestador{
		...
		public function insertar(Prestador $prestador){
			//INSERTAR PRESTADORES
			$van=0;
			$sql="INSERT INTO ACT_PRESTADOR (IDACTUACION, IDOEM, FECHA_INICIO)
			VALUES (".$prestador->getIdActuacion().",".$prestador->getIdOEM().",(SELECT SYSDATE FROM DUAL))";
