...
$encabezado=""."krd=$krd&depeBuscada=$depeBuscada&filtroSelect=$filtroSelect&tpAnulacion=$tpAnulacion&carpeta=$carpeta";
...
<tr>
	<td>
				...
				<td>
					...
					Buscar radicado(s) (Separados por coma)
						...
						<input name="busq_radicados" type="text" size="70" class="tex_area" value="<?=$busq_radicados?>">
								...
								<select name='tdocumento' id='tdocumento' class='select'>
		...
		<tr class="tablas">
			<td>
			<form name=form_busq_rad action='CRA.cuerpoarch.php?krd=<?=$krd?>&<?=session_name()."=".trim(session_id()).$encabezado?>' method=post>
				Buscar Expedientes(s) (Separados por coma)
				<input name="busq_expediente" type="text" size="70" class="tex_area" value="<?=$busq_expediente?>">
								<select name='tdocumento' id='tdocumento' class='select'>
									<option value=0>Seleccione un tipo documental</option>
									<option value=10>TODOS</option>
									<option value=1>SALIDAS</option>
				...
				<tr>
					<td width="50%"  class="titulos2">
						<table width="100%" border="0" cellspacing="0" cellpadding="0" align="left">
							<tr class="titulos2"><span class='etitulos'><b>
