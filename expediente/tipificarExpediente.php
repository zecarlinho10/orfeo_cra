...
if ($Actualizar && $tsub != -1 && $codserie != 0) {
    ...
    $NcDependencia = substr("000" . $dependenciaExp, -3);
    $numeroExpediente = $anoExp . $NcDependencia . $trdExp . $consecutivoExp . $digCheck;
    ...
    //echo "Dependencia exp:" . $dependenciaExp . "Numero expediente:" . $numeroExpediente . " Numero radicado:" . $nurad  . " depedencia:" . $dependencia  . " Codigo usuario:" . $codusuario . $usua_doc . $usuaDocExp . $codiSRD . $codiSBRD . $fechaExp;
    $numeroExpedienteE = $expediente->crearExpediente($numeroExpediente, $nurad, $NcDependencia, $codusuario, $usua_doc, $usuaDocExp, $codiSRD, $codiSBRD, 'false', $fechaExp, $_POST['codProc'], $arrParametro, $tipo=1);
                    ...
                    <table class="table table-bordered table-striped" style="width:850;" align=center>
                        <tr>
                          ...
                          ";
                                        ...
                                        if (!$dependenciaExp)
                                            $dependenciaExp = substr("000" . $dependencia, -3);
                        ...
                        <tr>
                            ...
                            7/03/2018
                            CARLOS RICAURTE 
                            Cambio de script para ver dependencia, serie y subserie
                            */
                            $querySub = "select distinct (su.sgd_sbrd_descrip||'-'||su.sgd_sbrd_codigo) as detalle, su.sgd_sbrd_codigo 
                                from sgd_mrd_matrird m, sgd_sbrd_subserierd su 
                                WHERE su.sgd_sbrd_codigo = m.sgd_sbrd_codigo and sysdate between su.sgd_sbrd_fechini and su.sgd_sbrd_fechfin
                                AND m.depe_codi = " . $dependenciaExp . " and m.sgd_srd_codigo = '$codserie'  AND su.sgd_srd_codigo = '$codserie' order by detalle";
                        ...
                        <tr><?
                            /* Se deshabilita ya que no se esta utilizando el flujo<td>
                                <small>Proceso</small>
                            </td>
                            <td colspan="2">
                                <label class=select>
                      ...
                      <table class="table table-bordered table-striped" style="width:850;" align=center>
                          <tr align="center">
                              <td width="5" colspan=4>
                                  ...
                                  //6/03/2018
                                  //CARLOS RICAURTE
                                  //CAMBIA EL CAMPO DE SERIE A 3 DIGITOS
                                  $trdExp = substr("000" . $codiSRD, -3) . substr("00" . $codiSBRD, -2);
                                  $consecutivoExp = substr("00000" . $secExp, -5);
                                  if (!$anoExp)
                                      $anoExp = date("Y");
                                  ...
                                  <?
                                    ...
                                    //CARLOS RICAURTE
                                    //CAMBIA EL CAMPO DE SERIE A 3 DIGITOS
                                  $dependenciaNExp = substr("000" . $dependenciaExp, -3)
                                  ?>
                                  <section class="col col-2"><label class=input><input type=text name=depExp value='<?= $dependenciaNExp ?>' class=select maxlength="3" size="3"> </label></section>
                                  <section class="col col-2"><label class=input><input type=text name=depExp value='<?= $trdExp ?>'  class=select maxlength="5" size="5"> </label></section>
                                  <section class="col col-2"><label class=input><input type=text name=consecutivoExp value='<?= $consecutivoExp ?>' class=select maxlength="5" size=5> </label></section>
                          ...
                          <tr>
                              <td colspan=4 align=center>
                                  ...
                                  $numeroExpediente = $anoExp . $dependenciaNExp . $trdExp . $consecutivoExp . $digCheck;
                                  ?>
                                  </center>
                                  <small>
    ...
    <table class="table table-bordered">
        <tr align="center">
            <td align="center">
                <center>
                    <?php
                    if ($codserie && !$Actualizar and $usuaDocExp) {
                        #echo "---------------------------";
                        if (!$crearExpediente) {
