...
<table width="350" class="borde_tab" cellpadding="5">
  ...
  <TR>
	...
	<input type="hidden" name=comentarios_dev value='<?=$comentarios_dev?>' class=tex_area size=70 >
    </TD>
  </TR><tr>
...
if($devolver_rad  and $motivo_devol)
{
 ...
 $condicion = $radicados_devOrginal;
    ...
    $num = count($checkValue);
	   ...
	   $i = 0;
		...
		$radicados_lis .= $record_id .",";
 	   	$chkt = $radicados_sel;
		 $systemDate = $db->conn->OffsetDate(0,$db->conn->sysTimeStamp);
	  	 // JUAN CARLOS VILLABA NOVIEMBRE 10/11/2015 sgd_deve_codigo = $motivo_devol igual a sgd_deve_codigo =0
		$isql = "update anexos
			set anex_estado=3,
			sgd_deve_fech=$systemDate,
			sgd_deve_codigo = 0
	...
	<TABLE width="100%" class='borde_tab' cellspacing="5"><TR><TD height="30" valign="middle"   class='listado2' align="center">
		<center><b>Se ha realizado la devoluci�n de los siguientes registros enviados<br>
