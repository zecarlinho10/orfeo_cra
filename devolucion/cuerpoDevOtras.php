<?
 ...
 $ADODB_FETCH_MODE = ADODB_FETCH_ASSOC;
  ...
  //if(!$fecha_ini) $fecha_ini = "2023/10/01";
...
-->
 <form name='formEnviar' action='../devolucion/dev_corresp_otras.php?<?=session_name()."=".session_id()."&krd=$krd" ?>&estado_sal=<?=$estado_sal?>&estado_sal_max=<?=$estado_sal_max?>' method='post'>
