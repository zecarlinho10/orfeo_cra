...
?>
<html><head><title>.: Reabrir Expedientes :.</title>
	...
	<td>
		...
		<TR>
			<td width='33%' >
      			...
      			<tr class="info">
      				<td height="20">Expedientes por reabrir en el Archivo de Gesti&oacute;n</td>
      			</tr>
      			</table>
      		</td>
			<td width='33%' >
...
<span class='etitulos'><b>
						...
						<option value=62>ABRIR EXPEDIENTE ARCHIVO GESTI&Oacute;N</option>
						</select><br>
					...
					<td width="50%" align=right class="titulos2" ><BR>
						...
						<BR>
						<input type=button value="ABRIR EXPEDIENTE" name=CERRAR valign="middle" class="botones_largo" onclick="enviar();">
...
include "$ruta_raiz/include/query/queryabrir_exp_especifico.php";
