...
function seHaRadicadoAnexo($cod){
    ...
    function anexarFilaRadicado($codMax = 0){
      ...
      $this->uploadDir = "/".substr($this->anex_codigo,0,4)."/".substr($this->anex_codigo,4,3)."/docs/";
      ...
      if(! ( $insert instanceof ADORecordSet_empty) && !empty($insert) &&  $insert==1)
      {
