...
require_once (realpath(dirname(__FILE__) . "/../")."/class_control/Municipio.php");
error_reporting(7);
...
class Dependencia
{
     ...
     * 
     * @param $codigo string
     *            es el codigo de la Dependencia
     * @return boolean
     */
     ...
     * Retorna el valor string correspondiente al codigo de la dependencia que permitiria generar la secuencia de radicacion de acuerdo al tipo de radicacion sea esta (-1,-2,-3,-4,-5) , debe invocarse antes Dependencia_codigo()
     * 
     * @param $codDepe numeric
     *            es el codigo de la Dependencia
     * @param $tipoRadicacion String
     *            es el tipo de radicacion a consultar
     * @return string
     *
     */
    ...
    public function getDependenciaList($userDepe)
    {
        $isql = "SELECT DEPE_NOMB, DEPE_CODI AS DEPE_CODI FROM DEPENDENCIA
