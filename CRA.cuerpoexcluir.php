...
?>
<table border=0 width=100% class="table table-striped table-bordered table-hover dataTable no-footer smart-form">
<tr>
	<td>
		...
		<TR>
			<td width='33%' >
      			...
      			<tr class="info">
      				<td height="20">Radicados por excluir en f&iacute;sico</td>
      			</tr>
      			</table>
      		</td>
			<td width='33%' >
...
<span class='etitulos'><b>
						...
						<option value=20>EXCLUIR EN FISICO</option>
						</select><br>
					...
					<td width="50%" align=right class="titulos2" ><BR>
						...
						<BR>
						<input type=button value="EXCLUIR" name=EXCLUIR valign="middle" class="botones" onclick="enviar();">
...
$sqlFechae = $db->conn->SQLDate("d-m-Y H:i A","t.hist_fech");
...
include "$ruta_raiz/include/query/queryCuerpoexcluir.php";
